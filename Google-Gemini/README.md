...
Google Gemini is a project aimed at replicating the functionality of Gemini, powered by the Google Gemini API, using React and CSS.
...
1. Clone the repository:
   ...
   ```bash
   git clone https://github.com/Prabhatsir31/Google-Gemini.git